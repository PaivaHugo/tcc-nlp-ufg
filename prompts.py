    ...
    def build_prompt_to_persona(self):
        prompt = """
            ...
            2. Um objeto JSON com as preferências da persona, incluindo:
                ...
                2.1 Scores com valores de 0 a 1 que representam o nível de interesse em cada tema: tecnologia, economia, ciência, saúde, educação, turismo, política e esporte.
                
            3. O tema principal da notícia
            4. time_do_coracao, se houver, para personalização de temas esportivos
            ...
            ** Orientar o assistente a não focar nos temas com baixo interesse (score < 0.40)
            ** Destacar os temas com maior interesse (score ≥ 0.75), como sugestão de foco
            ** Ajustar o tom: se o interesse no tema principal for baixo, o resumo deve ser breve; se for alto, o resumo pode ser mais detalhado e envolvente
            ...
            Se o tema for “esporte” e a notícia for sobre o time da persona, valorize a notícia para o torcedor, ou seja, gere o resumo como se estivesse falando com o torcedor.
        ...
        system_prompt.append(
            ("human", "{person_name} {user_prefs} {text_cat} {soccer_team}")
        )
...
class MaritacaPrompt(BasePrompt):
    ...
    def get(self, news_content, categoria, user_preferences, soccer_team):
        ...
        prompt = PromptTemplate.from_template(template.format(system_prompt=prompt_, news=news_content, preferences=user_preferences_))
